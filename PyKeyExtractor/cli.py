...
import PyKeyExtractor

LICENSE_URL = ('https://raw.githubusercontent.com/NLPIR-team/NLPIR/master/License/'
               'license%20for%20a%20month/KeyExtract%E5%85%B3%E9%94%AE%E8%AF%8D%E6%8F%90%E5%8F%96%E6%8E%88%E6%9D%83/'
               'keyExtract.user')
DATA_DIR = os.path.join(PyKeyExtractor.pykeyextractor.PACKAGE_DIR, 'Data')
LICENSE_FILENAME = 'keyExtract.user'


@click.group(context_settings=dict(help_option_names=['-h', '--help']),
             options_metavar='[<options>]',
             subcommand_metavar='<command> [<args>]')
@click.version_option(PyKeyExtractor.__version__, message='%(prog)s %(version)s')
def cli():
    """A simple command-line interface for PyKeyExtractor."""
    pass
